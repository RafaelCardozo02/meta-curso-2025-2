...
<head>
		...
		<!-- Core CSS -->
		<link rel="stylesheet" type="text/css" href="{{asset('frontend/assets/css/style.cs')}}s">
	</head>
	<body>
		<!-- App Start-->
		<div id="root">
                ...
                <form action="{{route('login_submit')}}" method="POST">
                    ...
                    <div class="form-container vertical">
                        ...
                        <div class="flex justify-between mb-6">
                            ...
                            <a class="text-primary-600 hover:underline" href="{{route('user_forgot_password')}}">Forgot Password?</a>
                        </div>
                        <button class="btn btn-solid w-full" type="submit">Login</button>
                        <div class="mt-4 text-center">
                            <span>Don't have an account yet?</span>
                            <a class="text-primary-600 hover:underline" href="{{route('user_register')}}">Register</a>
                        </div>
                    </div>
                </form>
            </div>
